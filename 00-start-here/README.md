...
5. [principles.md](principles.md)：如何记录事实、判断和不确定性。
6. [maintenance.md](maintenance.md)：如何持续维护这个仓库。

## 读完你应该知道

- 具身智能不是“多模态模型 + 机器人外壳”这么简单。
- 关键是感知、行动、环境反馈和学习组成闭环。
- 每篇论文、项目或产品都可以落到某个技术环节里理解。
- 初学阶段不需要一次性读懂所有公式，先建立系统地图更重要。
